"""
artifacts.py — Saving training artifacts to disk.

Two functions:
  save_training_artifacts  — single-channel (Algorithm 1) run
  save_joint_artifacts     — joint multi-channel (Algorithm 2) run
...
def save_training_artifacts(
    ...
    """
    Save Algorithm 1 (single-channel) artifacts.
...
def save_joint_artifacts(
    ...
    """
    Save Algorithm 2 (joint multi-channel) artifacts.
    ...
    print(f"Joint artifacts saved to {od}/")
